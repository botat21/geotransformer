...
class GeoTransformer(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        # TODO: debug
        print("ref_points_c: ", ref_points_c.shape)
        print("src_points_c: ", src_points_c.shape)
        print("ref_points_f: ", ref_points_f.shape)
        print("src_points_f: ", src_points_f.shape)
        print("gt_node_corr_overlaps", gt_node_corr_overlaps.shape)
        print("operands: ")
        print("ref_node_corr_knn_feats: ", ref_node_corr_knn_feats.shape)
        print("src_node_corr_knn_feats: ", src_node_corr_knn_feats.shape)
        print()
